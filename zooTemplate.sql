...
GO
	...
	INSERT INTO tbl_care
		...
		('care_5', 'move subject to exercise room', 3),
	...
	INSERT INTO tbl_habitat
		...
		('jungle vines and winding branched', 15000),
...
SELECT
		 species_name, specialist_fname, specialist_lname, specialist_contact
		FROM tbl_species
